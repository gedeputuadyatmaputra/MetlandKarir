...
<head>
    ...
    <title>Internship Karir | Metland</title>
    ...
    function addPengalamanKerja() {
        ...
        const newForm = `
            <div class="row pengalaman-kerja">
                ...
                <div class="col-sm-12">
                        <button type="button" class="btn btn-danger mb-4" onclick="removePengalamanKerja(this)">Remove</button>
                </div>
            </div>
        `;
        container.insertAdjacentHTML('beforeend', newForm);
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_intern" class="form-control" placeholder="Masukkan Nama Lengkap (Insert Full Name)" required>
                    </div>
                </div>
            </div>
            <div class="row">
...
<?php 
    if (isset($_POST['submit'])) {
      ...
      $level_kerja = isset($_POST['jabatan']) && !empty($_POST['jabatan_job']) ? implode('.', $_POST['jabatan']) : '-';
      ...
      $posisi_kerja = isset($_POST['pnglmn_posisi']) && !empty($_POST['pnglmn_job']) ? implode('.', $_POST['pnglmn_posisi']) : '-';
        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 3000000) { // Maksimal ukuran file 1MB
                    ...
                    $fileDestination = '../assets/cv_intern/' . $fileNameNew; 
      ...
      $sql_simpan = "INSERT INTO tb_intern (nama_intern, tempat_lahir, tanggal_lahir, pendidikan, jurusan_s, periode_s, ipk_s, jurusan_pasca, periode_pasca, ipk_pasca, bersedia_metlan, upload_cv, jurusan_d, periode_d, ipk_d, nama_organisasi, jabatan_organisasi, ket_organisasi, jekel, nama_perusahaan, jabatan, pnglmn_posisi, masa_kerja, ket_kerja, job_available, pernyataan_data, setuju_data, universitas_s, universitas_pasca, universitas_d)
      VALUES (
        '".$_POST['nama_intern']."',
        '".$_POST['tempat_lahir']."',
        '".$_POST['tanggal_lahir']."',
