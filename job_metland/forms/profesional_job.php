...
<head>
    ...
    <title>Profesional Karir | Metland</title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_pro" class="form-control" placeholder="Masukkan Nama Lengkap (Insert Full Name)" required>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div id="pengalamanKerjaContainer">
                <div class="row pengalaman-kerja">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Pengalaman Posisi Kerja (<i>Work Position Experience</i>)</label>
                            <textarea name="posisi_kerja[]" rows="2" class="form-control" placeholder="Pengalaman Posisi (Work Position Experience)"></textarea>
                        </div>
                    </div>
...
<?php 
    if (isset($_POST['submit'])) {
        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 3000000) { // Maksimal ukuran file 1MB
                    ...
                    $fileDestination = '../assets/cv_profesional/' . $fileNameNew; 
      ...
      $sql_simpan = "INSERT INTO tb_profesional (nama_pro, tempat_lahir, tanggal_lahir, pendidikan, jurusan_s, periode_s, ipk_s, jurusan_pasca, periode_pasca, ipk_pasca, bersedia_metlan, upload_cv, jurusan_d, periode_d, ipk_d, nama_organisasi, jabatan_organisasi, ket_organisasi, jekel, nama_perusahaan, level_kerja, posisi_kerja, masa_kerja, ket_kerja, job_available, pernyataan_data, setuju_data, universitas_s, universitas_pasca, universitas_d)
      VALUES (
        '".$_POST['nama_pro']."',
        '".$_POST['tempat_lahir']."',
        '".$_POST['tanggal_lahir']."',
