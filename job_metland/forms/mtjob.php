        ...
        const newForm = `
            <div class="row pengalaman-kerja">
                ...
                <div class="col-sm-6">
                        ...
                        <input type="text" name="jabatan[]" class="form-control" placeholder="Level Jabatan (Job Level)"/>
                </div>
                <div class="col-sm-6">
                        <div class="form-group">
                            <label>Pengalaman Posisi Kerja (<i>Work Position Experience</i>)</label>
                            <input name="pnglmn_posisi[]" rows="2" class="form-control" placeholder="Pengalaman Posisi Kerja (Work Position Experience)"/> 
                        </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
    ...
    <div style="background-color: white" class="container p-3 my-3 border">
        ...
        <form id="form" method="POST" enctype="multipart/form-data">
            <div class="alert alert-secondary">
                <strong>FORMULIR PRIBADI</strong>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label>Nama Lengkap (<i>Full Name</i>) <strong style="color: red;">*</strong></label>
                        <input type="text" name="nama_mt" class="form-control" placeholder="Masukkan Nama Lengkap (Insert Full Name)" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-7">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir (Place Of Birth)" required>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" name="tanggal_lahir" class="form-control" placeholder="Tanggal Lahir (Date Of Birth)" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="pendidikan" id="pendidikan" class="form-control" required onchange="showEducationFields()">
                            <option value="" disabled selected>Pilih Pendidikan</option>
                            <option name="pendidikan" value="Sarjana">Sarjana</option>
                            <option name="pendidikan" value="Pasca Sarjana">Pasca Sarjana</option>
            ...
            <div class="row">
                <div class="col-sm-12 mt-3">
                    <div class="form-group">
                        <label>Upload CV <strong style="color: red;"> *</strong></label>
                        <div class="mb-3">
                            <p for="upload_cv" class="form-label">Upload CV (pdf)</p>
                            <input type="file" class="form-control" id="upload_cv" name="upload_cv" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" name="bersedia_unit" type="checkbox" value="Bersedia" id="flexCheckDefault" required>
                <label class="form-check-label" for="flexCheckDefault">
                    Bersedia ditempatkan diseluruh unit Metland <strong style="color: red;">*</strong>
                </label>
            </div>
            ...
            <div class="form-check mb-3">
                ...
                <p class="form-check-label" for="flexCheckDefault">
                    Dengan ini saya menyatakan bahwa informasi yang saya berikan adalah benar. Apabila terdapat informasi yang tidak benar maka saya 
                    bersedia mempertanggungjawabkan segala akibatnya. Saya memahami bahwa keputusan diterima atau tidaknya lamaran saya tergantung pada proses seleksi berikutnya.<strong style="color: red;"> *</strong>
                </p>
            </div>
...
<?php 
    if (isset($_POST['submit'])) {
      ...
      //Menyimpan data yang bisa menerima lebih dari 1 data ke dalam field nama_organisasi, jabatan, ket. Apabila nilainya kosong akan mengeluarkan output ' - '
      ...
      //Menyimpan data yang bisa menerima lebih dari 1 data ke dalam field nama_perusahaan, jabatan, masa_kerja, ket_kerja, dan posisi. Apabila nilainya kosong akan mengeluarkan output ' - '
      $nama_perusahaan = isset($_POST['nama_perusahaan']) && !empty($_POST['nama_perushaan']) ? implode('.', $_POST['nama_perusahaan']) : '-';
      $jabatan = isset($_POST['jabatan']) && !empty($_POST['jabatan_job']) ? implode('.', $_POST['jabatan']) : '-';
      ...
      $pnglmn_posisi = isset($_POST['pnglmn_posisi']) && !empty($_POST['pnglmn_job']) ? implode('.', $_POST['pnglmn_posisi']) : '-';
      
      $bersedia_unit = isset($_POST['bersedia_unit']) ? $_POST['bersedia_unit'] : "Tidak Bersedia";
        ...
        if (in_array($fileActualExt, $allowed)) {
            if ($fileError === 0) {
                if ($fileSize < 3000000) { // Maksimal ukuran file 1MB
                    ...
                    $fileDestination = '../assets/filecv/' . $fileNameNew; 
      ...
      $sql_simpan = "INSERT INTO tb_mt (nama_mt, tempat_lahir, tanggal_lahir, pendidikan, jurusan_s, periode_s, ipk_s, jurusan_pasca, periode_pasca, ipk_pasca, bersedia_unit, upload_cv, jurusan_d, periode_d, ipk_d, nama_organisasi, jabatan_organisasi, ket_organisasi, jekel, nama_perusahaan, jabatan, masa_kerja, ket_kerja, pnglmn_posisi, pernyataan_data, setuju_data, universitas_s, universitas_pasca, universitas_d)
      VALUES (
        '".$_POST['nama_mt']."',
        '".$_POST['tempat_lahir']."',
        '".$_POST['tanggal_lahir']."',
