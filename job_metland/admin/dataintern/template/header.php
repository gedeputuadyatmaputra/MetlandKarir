        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item <?php if($currentPage == '../datapro/datapro.php') { echo 'active'; } ?>">
                        <a href="../datapro/datapro.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-table"></i>
                            <div data-i18n="Analytics">Data Profesional</div>
                        </a>
                    </li>

                    <li class="menu-item <?php if($currentPage == 'data_intern.php') { echo 'active'; } ?>">
                        <a href="data_intern.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-table"></i>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    ...
                                                    <?php else: ?>
                                                        <img src="../../assets/img/defaultprofile.jpg../../assets/img/defaultprofile.jpg" class="w-px-40 h-auto rounded-circle"/>
                                                    <?php endif; ?>
                                                    </div>
                                                </div>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="data_intern.php?logout=1">
