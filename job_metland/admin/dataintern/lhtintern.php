...
$sql = "SELECT * FROM tb_intern WHERE id_intern = $id_mt";
...
<div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card-body">
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <th>File CV</th>
                        <td><a href="../../assets/cv_intern/<?php echo $row['upload_cv']; ?>" target="_blank">Lihat CV</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <a href="data_intern.php" class="btn btn-secondary mt-3">Kembali</a>
</div>
<!-- / Content -->
