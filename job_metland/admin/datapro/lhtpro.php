...
$sql = "SELECT * FROM tb_profesional WHERE id_pro = $id_mt";
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Detail Data Calon Karyawan Profesional</h4>
        ...
        <div class="card-body">
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <th>File CV</th>
                        <td><a href="../../assets/cv_profesional/<?php echo $row['upload_cv']; ?>" target="_blank">Lihat CV</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <a href="datapro.php" class="btn btn-secondary mt-3">Kembali</a>
</div>
<!-- / Content -->
