...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <?php 
        ...
        $sql = "SELECT * FROM tb_profesional WHERE 1=1";
    ...
    <h4 class="fw-bold py-3 mb-4">Data Calon Karyawan Profesional</h4>
            ...
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../../assets/cv_profesional/<?php echo $row['upload_cv']; ?>" class="btn btn-success btn-sm" target="_blank">Lihat CV</a> | 
                            <a href="../../assets/cv_profesional/<?php echo $row['upload_cv']; ?>" class="btn btn-warning btn-sm" download>Download CV</a>
                        </td>
                        <td>
                            <a href="lhtpro.php?id=<?php echo $row['id_pro']; ?>" class="btn btn-warning btn-sm" onclick="return confirm('Apakah Ingin Lihat Data ?')">Lihat</a>
                            <br>
                            <a href="delpro.php?id=<?php echo $row['id_pro']; ?>" class="btn btn-danger btn-sm mt-4" onclick="return confirm('Apakah Ingin Hapus Data ?')">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
